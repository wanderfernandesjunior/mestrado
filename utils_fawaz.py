...
ITERATIONS = 1  # number of random runs for random initializations # original 5
...
def transform_mts_to_ucr_format():
    mts_root_dir = r'C:/Users/wander/Google Drive/Mestrado/Qualificação/dl-4-tsc/archives/mts_archive/'
    mts_out_dir = r'C:/Users/wander/Google Drive/Mestrado/Qualificação/dl-4-tsc/archives/mts_archive/'
    for dataset_name in MTS_DATASET_NAMES:
...
def viz_perf_train_size(root_dir, df):
    df_size = df.copy()
    train_sizes = []
    datasets_dict_ucr = read_all_datasets(root_dir, archive_name='3w_archive')
